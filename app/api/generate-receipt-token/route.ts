...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    // Check if order is paid (payment_confirmed_at must exist)
    ...
    // Generate receipt download token (reuse invoice token function)
    ...
    console.error('Unexpected error in generate-receipt-token:', error);
